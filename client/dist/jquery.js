    ...
    var templates = {
        ...
        "lists":       "<li>" +
                           "<div class='btn-group'>" +
                               ...
                               "<a class='btn btn-default' data-wysihtml5-command='Outdent' title='Outdent'><i class='fa fa-indent'></i></a>" +
                               "<a class='btn btn-default' data-wysihtml5-command='Indent' title='Indent'><i class='fa fa-dedent'></i></a>" +
                           "</div>" +
                       "</li>",
        "link":        "<li>" +
                           "<div class='bootstrap-wysihtml5-insert-link-modal modal hide fade'>" +
                               ...
                               "</div>" +
                           "</div>" +
                           "<a class='btn btn-default' data-wysihtml5-command='createLink' title='Link'><i class='fa fa-link'></i></a>" +
                       "</li>",
        "image":       "<li>" +
        ...
        "html":
                       "<li>" +
                           "<div class='btn-group'>" +
                               "<a class='btn btn-default' data-wysihtml5-action='change_view' title='Edit HTML'><i class='fa fa-code'></i></a>" +
                           "</div>" +
                       "</li>"
    };
...
(function ($) {
    $.fn.html5lightbox = function (options) {
        ...
        inst.options = jQuery.extend({
            ...
            fadespeed: 400,
            skinfolder: "skins/",
            loadingimage: "static/img/lightbox-loading.gif",
            nextimage: "static/img/lightbox-next.png",
            previmage: "static/img/lightbox-prev.png",
            closeimage: "static/img/lightbox-close.png",
            playvideoimage: "static/img/lightbox-playvideo.png",
        ...
        inst.options.isIE678 =
            inst.options.isIE && !inst.options.isIE9;
        ...
        inst.createMarkup = function () {
            ...
            inst.$lightbox = jQuery("<div id='html5-lightbox' style='display:none;top:0px;left:0px;width:100%;height:100%;z-index:9999999;'>" + "<div id='html5-lightbox-overlay' style='display:block;position:absolute;top:0px;left:0px;width:100%;height:100%;background-color:" +
                ...
                "'></div>" + "</div>" + "<div id='html5-watermark' style='display:none;position:absolute;left:" + String(inst.options.bordersize + 2) + "px;top:" + String(inst.options.bordersize + 2) + "px;'></div>" + "</div>" + "</div>");
            inst.$lightbox.css({
        ...
        inst.showVideo = function (elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function () {
                ...
                if (inst.options.isMobile) isHTML5 = true;
                    ...
                    if (!inst.options.isFirefox || inst.options.isFirefox && (elem[ELEM_HREF_OGG] || elem[ELEM_HREF_WEBM])) isHTML5 = true;
                if (isHTML5) {
                    var videoSrc = elem[ELEM_HREF];
                    if (inst.options.isFirefox || !videoSrc) videoSrc = elem[ELEM_HREF_WEBM] ? elem[ELEM_HREF_WEBM] : elem[ELEM_HREF_OGG];
        ...
        inst.showYoutubeVimeo = function (elem) {
            ...
            inst.resizeLightbox(dataW, dataH, true, function () {
                ...
                $("#html5lightbox-video").html("<iframe width='" + dataW +
                    "' height='" + dataH + "' src='" + href + "' frameborder='0' webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>");
                inst.$elem.show();
                inst.showData()
            })
        };
        ...
        inst.resizeWindow = function () {
            var boxT = Math.round($(window).height() /
                2 - (inst.$lightboxBox.height() + inst.options.barheight) / 2);
        ...
        inst.showLightbox = function (type, href, title, width, height, webm,
            ...
            inst.loadElem(new Array(type,
                href, title, null, width, height, webm, ogg))
        };
    ...
    $.fn.amazingslider = function (options) {
        ...
        AmazingSlider.prototype = {
            ...
            init: function (instance) {
                ...
                else if (instance.options.randomplay) firstSlide = Math.floor(Math.random() * instance.elemArray.length);
            ...
            createWatermark: function () {
                ...
                if (this.options.watermarkstyle == "text") html += this.options.watermarktext;
                    ...
                    "image") html += "<img src='" + this.options.skinsfolder + this.options.watermarkimage + "' style='border:none;' />";
            ...
            initVideoApi: function () {
                ...
                for (i = 0; i < this.elemArray.length; i++) {
                    ...
                    for (j = 0; j < videos.length; j++)
                        ...
                        else if (videos[j].type == TYPE_VIDEO_VIMEO) initVimeo =
                        true
                }
                if (initYoutube) {
                    ...
                    if (instance.options.navthumbnavigationstyle ==
                        ...
                        if (instance.options.navdirection == "horizontal") {
                            var n = Math.floor(($nav.width() -
                                2 * m + instance.options.navspacing) / (instance.options.navwidth + instance.options.navspacing)); /*m=Math.floor(($nav.width()-n*instance.options.navwidth-(n-1)*instance.options.navspacing)/2)*/
                            m = 35;
                        }
            ...
            createNavBullet: function (index) {
                ...
                if (this.options.navstyle == "bullets") {
                    ...
                    $(imgLoader).load(function () {
                        ...
                        var imgHtml = "<div style='display:block;position:absolute;width:" + instance.options.navimagewidth + "px;height:" + instance.options.navimageheight + "px;overflow:hidden;'>";
                       	if (instance.options.lightboxmode)
                       		imgHtml = imgHtml + "<a href='" + instance.elemArray[index][ELEM_SRC] + "' data-lightbox='"+instance.options.lightboxid+"'>";
                       	imgHtml = imgHtml + "<img src='" + instance.elemArray[index][ELEM_THUMBNAIL] + "' style='" + style + "' />";
                       	if (instance.options.lightboxmode)
                       		imgHtml = imgHtml + "</a>";
                       	imgHtml = imgHtml + "</div>";
                       	$bullet.append(imgHtml);
        ...
        this.each(function () {
            ...
            var defaultOptions = {
            	//NSOR: rajout lightboxmode pour ne pas afficher l'image en grand
            	lightboxmode: false,
            	lightboxid: 'lightbox',
                previewmode: false,
                isresponsive: true,
                ...
                timerheight: 2,
                autoplayvideo: false,
                playvideoimage: "static/img/play-video.png",
                ...
                bottomshadowimage: "static/img/bottom-shadow.png",
                ...
                arrowimage: "static/img/arrows.png",
                arrowwidth: 32,
                arrowheight: 32,
                arrowmargin: 0,
                ...
                arrowtop: 50,
                showribbon: false,
                ribbonimage: "static/img/ribbon_topleft-0.png",
                ...
                navpreviewarrowimage: "static/img/preview-arrow.png",
                ...
                navimage: "static/img/bullets.png",
                navradius: 0,
                navcolor: "",
                navhighlightcolor: "",
                ...
                navbuttonbgimage: "static/img/navbuttonbgimage.png",
                ...
                navfeaturedarrowimage: "static/img/featured-arrow.png",
                ...
                navthumbnavigationarrowimage: "static/img/carousel-arrows-32-32-0.png",
                navthumbnavigationarrowimagewidth: 32,
                navthumbnavigationarrowimageheight: 32,
                navshowplayvideo: true,
                navplayvideoimage: "static/img/play-32-32-0.png",
            ...
            if (this.options.skinsfoldername.length > 0) this.options.skinsfolder = this.options.jsfolder + this.options.skinsfoldername + "/";
                ...
                this.options.jsfolder; if (this.options.versionmark != "AMC" + "om") {
